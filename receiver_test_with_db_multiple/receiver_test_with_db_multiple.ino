...
#define INFLUXDB_TOKEN "OtZ_cycJeCZkoE1lQzkfXuWrfp-a-XNjnxdv7uhH_3SCO3aaxZtUKDM2zf0X_SOtGhCi_T2huTuuB5L1mR0jWg=="
#define INFLUXDB_ORG "96406975c55e1f1d"
...
void loop() {
  if (new_vals) {
    ...
    for (int i = 0; i < pkt.numMeasurements; i++) {
      sensor.addField(pkt.labels[i], pkt.values[i]);
    }
